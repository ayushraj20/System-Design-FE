...
Size Limit -> 5MB per domain (significantly more than the storage capacity provided by cookies.)
...
Data Persistence -> Data stored in LocalStorage is persistent and will remain even after the browser is closed and reopened.
